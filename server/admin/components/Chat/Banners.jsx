...
class Banners extends React.Component {
    ...
    componentWillMount() {
        this.props.getBanners(this.props.state.login.body.agent[0].company_id);
    }
    ...
    bannersPopup() {
        ...
        return  (
            <Modal show={true} onHide={this.closePopup.bind(this)}>
                <Modal.Body>
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-3">
                            <RaisedButton primary={true} label="Choose" onClick={() => {this.sendBanner(this.state.selectedBannerId, this.props.state.banners.selectedBannerSessionHash, this.props.state.login.body.agent[0].company_id)}} />
                        </div>
